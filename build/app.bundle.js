...
/***/function (module, exports, __webpack_require__) {
	...
	var alt = __webpack_require__(1),
	    InsultActions = __webpack_require__(16);

	InsultActions.fetchInsult();

	document.getElementById('insult-button').onclick = function () {
...
/***/function (module, exports, __webpack_require__) {
	...
	var _StateFunctions = __webpack_require__(7);
	...
	var _AltUtils = __webpack_require__(10);
			...
			value: function fetchInsult() {
				...
				return function (dispatch) {
					...
					InsultSource.fetch().then(function (insult) {
						_this5.updateInsult(insult);
					}).catch(function (error) {
						_this5.insultFailed(error);
					});
				};
			}
		}]);
