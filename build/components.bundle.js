...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<insult></insult> <button id="insult-adder" onclick="{this.handleClick}">Insult me</button>', '', '', function (opts) {
	    ...
	    var InsultStore = __webpack_require__(1),
	        InsultAction = __webpack_require__(18),
	...
	riot.tag2('insult', '<article class="insult-container"> <h3 if="{insult}">{insult}</h3> <p if="{fetching}">Wait for it...</p> </article>', 'insult,[riot-tag="insult"],[data-is="insult"]{ display: block; } insult h3,[riot-tag="insult"] h3,[data-is="insult"] h3{ color: red; }', '', function (opts) {
	    ...
	    var InsultStore = __webpack_require__(1),
	        ...
	        _this2.insult = state.insult.body;
	        _this2.fetching = state.insult.fetching;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Redux = __webpack_require__(2),
	    ReduxThunk = __webpack_require__(16).default,
	    insultsApp = __webpack_require__(17);

	module.exports = Redux.createStore(insultsApp, Redux.applyMiddleware(ReduxThunk));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Redux = __webpack_require__(2),
	    ...
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { body: null } : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UPDATE = 'insultUpdate',
	    ...
	    InsultService = __webpack_require__(19),
	    ...
	    return function (dispatch) {
	        ...
	        return InsultService.fetch().then(function (insult) {
	            return dispatch(receiveInsult(insult));
	        });
	    };
	};

	module.exports = {
	    fetchInsult: fetchInsult,
	    UPDATE: UPDATE,
	    REQUESTED: REQUESTED,
	    RECEIVED: RECEIVED
	};
